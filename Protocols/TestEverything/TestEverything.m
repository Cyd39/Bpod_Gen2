function TestEverything()
    ...
    for currentTrial = 1:NumTrials
        ...
        sma = SetCondition(sma, 1, 'BNC1', 1); % Condition 1: BNC1 is HIGH (licking detected)
        ...
        if ThisITI-QuietTime > 0
            ...
            sma = AddState(sma, 'Name', 'NoLick', ...
                'Timer', QuietTime, ...
                'StateChangeConditions', {'Condition1', 'NoLick', 'Tup', 'Stimulus'}, ... % Use condition to detect BNC1 state
                'OutputActions', {});
        else
            sma = AddState(sma, 'Name', 'Ready', ...
                'Timer', ThisITI, ...
