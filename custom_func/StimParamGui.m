function StimParams = StimParamGui()
    ...
    h.SoundType = uicontrol('Parent', soundPanel, ...
        'Style', 'popup', ...
        'String', {'White Noise', 'AM Noise', 'Click Train',  'Bandpass Noise'}, ...
        'Units', 'normalized', ...
    ...
    function createBehaviorControls(parent)
        ...
        uicontrol('Parent', parent, ...
            'Style', 'text', ...
            'String', 'Catch Trial Percentage(%):', ...
            'Units', 'normalized', ...
            'Position', [0.02 0.3 0.5 0.04],...
            'FontSize', 12);
        h.Behave.PercCatch = uicontrol('Parent', parent, ...
            'Style', 'edit', ...
            'String', '0.2', ...
            'Units', 'normalized', ...
    ...
    function setStimParams(~, ~)
        ...
        StimParams.Behave.PercCatch = str2double(get(h.Behave.PercCatch, 'String'));
