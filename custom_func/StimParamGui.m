function StimParams = StimParamGui()
    ...
    function createRemainingVibrationControls(parent)
        ...
        uicontrol('Parent', parent, ...
            ...
            'String', 'Duration (ms):', ...
            'Units', 'normalized', ...
            'Position', [0.05 0.5 0.4 0.12],...
            'FontSize', 14);
        h.Vib.Duration = uicontrol('Parent', parent, ...
            'Style', 'edit', ...
            'String', '500', ...
            'Units', 'normalized', ...
            'Position', [0.5 0.5 0.4 0.12],...
            'FontSize', 14);
        ...
        uicontrol('Parent', parent, ...
            ...
            'String', 'Frequency (Hz):', ...
            'Units', 'normalized', ...
            'Position', [0.05 0.2 0.4 0.12],...
            'FontSize', 14);
        h.Vib.Frequency = uicontrol('Parent', parent, ...
            'Style', 'edit', ...
            'String', '100', ...
            'Units', 'normalized', ...
            'Position', [0.5 0.2 0.4 0.12],...
            'FontSize', 14);
